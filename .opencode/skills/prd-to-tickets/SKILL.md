---
name: prd-to-tickets
description: Break a PRD into independently-grabbable tickets using tracer-bullet vertical slices. Use when user wants to convert a PRD to tickets, create implementation tickets, or break down a PRD into work items.
---

# PRD to Tickets

Break a PRD into independently-grabbable tickets using vertical slices (tracer bullets).
